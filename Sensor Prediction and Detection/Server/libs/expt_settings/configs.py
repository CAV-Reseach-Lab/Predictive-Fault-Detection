...
Contains the default output paths for data, serialized models and predictions
for the main experiments used in the publication.
"""

import os

import libs.data_formatters.electricity
import libs.data_formatters.favorita
import libs.data_formatters.traffic
import libs.data_formatters.volatility
import libs.data_formatters.a2d2
import libs.data_formatters.a2d2_practical
...
class ExperimentConfig(object):
  ...
  Attributes:
    ...
    model_folder: Folder to store serialized models.
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita','a2d2','a2d2Practical']

  def __init__(self, experiment='a2d2', root_folder=None):
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        'volatility': libs.data_formatters.volatility.VolatilityFormatter,
        'electricity': libs.data_formatters.electricity.ElectricityFormatter,
        'traffic': libs.data_formatters.traffic.TrafficFormatter,
        'favorita': libs.data_formatters.favorita.FavoritaFormatter,
        'a2d2': libs.data_formatters.a2d2.A2D2Formatter,
        'a2d2Practical': libs.data_formatters.a2d2_practical.A2D2PracticalFormatter
    }
